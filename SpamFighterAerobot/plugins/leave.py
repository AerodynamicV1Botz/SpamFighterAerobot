...
@BOT0.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT1.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT2.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT3.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT4.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT5.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT6.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT7.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT8.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
@BOT9.on(events.NewMessage(incoming=True, pattern=r"\%sleave@SpamFighter_Aerobot(?: |$)(.*)" % hl))
async def _(e):
